...
def fix_file(filepath):
    ...
    for curr_line in curr_lines:
        ...
        if norm in git_index:
            ...
            # 选择长度最接近的候选
            best = min(candidates, key=lambda g: abs(len(g) - len(curr_line)))

    ...
    >
      ...
      <div class="custom-section">
        ...
        <div class="custom-input-row">
          ...
          <InputText
            v-model="localCustomHex"
            placeholder="RRGGBB"
            class="flex-1"
            maxlength="6"
            @blur="$emit('apply-custom')"
            @keydown.enter="$emit('apply-custom')"
          />
          <div
            class="custom-preview"
            :style="{ backgroundColor: isValidCustomHex ? '#' + localCustomHex : undefined }"
          />
        </div>
        <small
          v-if="customError"
      ...
      <div class="class-section">
        ...
        <div class="class-tags">
          <button
            v-for="cls in CLASS_NAME_OPTIONS"
            :key="cls"
            type="button"
            class="class-tag"

      ...
      <div class="flex flex-wrap gap-2">
        ...
        >
          <img
            ...
            :alt="getProfessionName(cmd.profession)"
          >
          <div class="min-w-0">
      ...
      >
        ...
        >
          <div class="flex items-center justify-between text-xs">
            ...
            <span class="font-semibold text-primary">{{ fmtCompact(g.total_damage) }}</span>
          </div>
          <div class="flex items-center justify-between text-xs">
            <span class="text-neutral-text-secondary">平均DPS</span>
            <span class="font-semibold text-neutral-text">{{ fmtCompact(g.avg_dps) }}</span>
          </div>
          <div class="flex items-center justify-between text-xs">
          ...
          <div class="flex items-center justify-between text-xs">
            ...
            <span class="font-semibold text-warning">{{ g.total_downed }}</span>
          </div>
        </div>
      </div>
...
import { fmtCompact, groupColor, scoreValueColor } from '@/composables/combat/useCombatHelpers'

<template>
  ...
  >
    ...
    >
      ...
      <span class="text-sm text-neutral-text-secondary">正在上传 dps.report 并等待分析完成</span>
    </div>
    <div
      v-else-if="result"
  ...
  >
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
      ...
      <div class="text-center p-3 rounded bg-neutral-bg">
        ...
        >查看报告 <i class="pi pi-external-link text-xs" /></a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      >
        ...
        >旋转配置 {{ result.has_rotation ? '有' : '否' }}</span>
      </div>
      <div
        class="flex items-center gap-2 p-3 rounded"
      ...
      >
        ...
        >武器配置 {{ result.has_weapons ? '有' : '否' }}</span>
      </div>
      <div
        class="flex items-center gap-2 p-3 rounded"
      ...
      >
        ...
        >死亡回放 {{ result.has_death_recap ? '有' : '否' }}</span>
      </div>
    </div>
  </div>

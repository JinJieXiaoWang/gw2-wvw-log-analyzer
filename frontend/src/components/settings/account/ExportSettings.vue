    ...
    <div class="relative z-10">
      ...
      <div class="space-y-8">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div
              ...
              :class="localExportSettings.defaultFormat === format.id
                ? 'border-primary shadow-lg shadow-primary/10'
                : 'border-transparent hover:border-neutral-border-light'"
              @click="localExportSettings.defaultFormat = format.id"
            >
              <!-- 选中指示器 -->
              <div
                v-if="localExportSettings.defaultFormat === format.id"
              ...
              <div
                ...
                :class="localExportSettings.defaultFormat === format.id ? 'bg-primary/15' : 'bg-neutral-card group-hover:bg-primary/5'"
              >
                <i
                  :class="format.icon"
        ...
        <div>
          ...
          <div class="space-y-3">
            <SettingItem
              ...
              icon-color="primary"
            >
              <InputSwitch v-model="localExportSettings.includeHeader" />
            </SettingItem>
            <SettingItem
              title="UTF-8 编码"
            ...
            >
              <InputSwitch v-model="localExportSettings.utf8Encoding" />
            </SettingItem>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="max-w-sm">
            <BaseSelect
              v-model="localExportSettings.numberFormat"
...
const emit = defineEmits<{
  ...
  'update:exportSettings': [exportSettings: ExportSettings]
}>()

const localExportSettings = reactive({ ...props.exportSettings })

watch(() => props.exportSettings, (val) => {
  Object.assign(localExportSettings, val)
}, { deep: true })

watch(localExportSettings, (val) => {
  emit('update:exportSettings', { ...val })
}, { deep: true })

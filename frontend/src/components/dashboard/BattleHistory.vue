<template>
  <div class="card animate-slide-in-up" style="animation-delay: 1s">
    <div class="flex items-center justify-between mb-4">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h3 class="text-lg font-semibold text-neutral-text">最近战斗</h3>
          <p class="text-xs text-neutral-text-secondary">最近的战场记录</p>
        </div>
      </div>
    </div>
    ...
    <div v-else class="overflow-x-auto -mx-4 px-4">
      ...
      >
      <Column field="start_time" header="时间">
        <template #body="{ data }">

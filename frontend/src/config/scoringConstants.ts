...
export const DEFAULT_ROLE_TYPES = [
  { type: ROLE_TYPES.DPS, label: '输出', description: '以伤害输出为主要职责', icon: 'pi pi-bolt', color: '#FF4D6A' },
  { type: ROLE_TYPES.SUPPORT, label: '辅助', description: '以治疗和增益为主要职责', icon: 'pi pi-heart', color: '#00D68F' },
  { type: ROLE_TYPES.TANK, label: '承伤', description: '以吸收伤害和控制为主要职责', icon: 'pi pi-shield', color: '#9D4EDD' },
]

...
def extract_player_stats(ei_json: Dict[str, Any], friendly_team_id: int = 0) -> List[Dict[str, Any]]:
    ...
    for ei_p in ei_json.get("players", []):
        ...
        player = {
            ...
            "regeneration_uptime": buff_uptimes.get("regeneration", 0),
            "swiftness_uptime": buff_uptimes.get("swiftness", 0),
            "vigor_uptime": buff_uptimes.get("vigor", 0),
            "aegis_uptime": buff_uptimes.get("aegis", 0),
            "resistance_uptime": buff_uptimes.get("resistance", 0),
            "resolution_uptime": buff_uptimes.get("resolution", 0),
...
def build_fight_stats_mappings(
    ...
    for account, member in member_map.items():
        ...
        mappings.append({
            ...
            "regeneration_uptime": p.get("regeneration_uptime", 0),
            "swiftness_uptime": p.get("swiftness_uptime", 0),
            "vigor_uptime": p.get("vigor_uptime", 0),
            "aegis_uptime": p.get("aegis_uptime", 0),
            "resistance_uptime": p.get("resistance_uptime", 0),
            "resolution_uptime": p.get("resolution_uptime", 0),

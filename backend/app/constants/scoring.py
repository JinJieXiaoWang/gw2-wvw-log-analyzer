...
SCORING_DIMENSIONS = [
    ...
    {"key": "quickness", "label": "急速覆?},
    {"key": "survival", "label": "生存能力"},
    {"key": "strips", "label": "破法"},
    {"key": "cleanses", "label": "净?},
    {"key": "kills", "label": "击杀"},
...
# 默认评分规则权重（规则表为空时的兜底配置?DEFAULT_FALLBACK_RULES = {
    "damage_weight": 0.35,
...
# 评分规则内存缓存 TTL（秒?RULE_CACHE_TTL_SECONDS = 60.0
...
# 高机动性职业列表（用于机动能力评分?MOBILE_PROFESSIONS = ["盗贼", "游侠", "战士", "魂武?]

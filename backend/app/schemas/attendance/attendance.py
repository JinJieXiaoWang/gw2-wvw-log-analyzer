...
class AccountFilterParams(BaseModel):
    ...
    server_name: Optional[str] = Field(None, description="服务器筛选")
    map_name: Optional[str] = Field(None, description="地图筛选")
    profession: Optional[str] = Field(None, description="职业筛选")

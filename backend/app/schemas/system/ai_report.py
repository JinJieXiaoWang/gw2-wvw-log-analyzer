...
class FightAnalysisContent(BaseModel):
    # 功能：战斗分析内容模型    model_config = ConfigDict(from_attributes=True)
...
class SkillAnalysisContent(BaseModel):
    # 功能：技能循环分析内容模型    model_config = ConfigDict(from_attributes=True)
...
class TrendAnalysisContent(BaseModel):
    # 功能：趋势分析内容模型    model_config = ConfigDict(from_attributes=True)

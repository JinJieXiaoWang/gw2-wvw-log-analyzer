...
class RoleTypeBase(BaseModel):
    role_key: str = Field(..., description="角色定位?)
...
class ProfessionBase(BaseModel):
    profession_key: str = Field(..., description="职业?)
    profession_name: str = Field(..., description="职业中文?)
    profession_name_en: Optional[str] = Field(None, description="职业英文?)
    color: Optional[str] = Field(None, description="颜色")
    icon: Optional[str] = Field(None, description="图标")
...
class EliteSpecBase(BaseModel):
    spec_key: str = Field(..., description="精英特长?)
    spec_name: str = Field(..., description="精英特长中文?)
    spec_name_en: Optional[str] = Field(None, description="精英特长英文?)

...
from app.schemas.fight import FightListResponse, FightResponse, FightStatsResponse
...
async def get_fight(fight_id: int, db: Session = Depends(get_db)):
    ...
    stats_data = [
        FightStatsResponse(
            ...
            member_name=stats.character_name or stats.account,
            profession=stats.profession,
            damage=stats.damage,
            healing=stats.healing or 0,
            kills=stats.killed,
            deaths=stats.dead_count,
            time_in_combat=0,
            damage_taken=stats.damage_taken or 0,
            down_count=stats.down_count or 0,
            res_count=stats.resurrects or 0,
        )
        for stats in fight.fight_stats
    ]

...
async def get_overview(
    ...
    try:
        ...
        return ApiResponse(success=False, message=f"获取概览失败: {str(e)}", code=500)
...
async def get_trends(
    ...
    try:
        ...
        return ApiResponse(success=False, message=f"获取趋势失败: {str(e)}", code=500)
...
async def get_profession_distribution(
    ...
    try:
        ...
        logger.error(f"获取职业分布失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取职业分布失败: {str(e)}", code=500
        )
...
async def get_map_stats(
    ...
    try:
        ...
        logger.error(f"获取地图统计失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取地图统计失败: {str(e)}", code=500
        )
...
async def get_top_players(
    ...
    try:
        ...
        logger.error(f"获取玩家排行失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取排行失败: {str(e)}", code=500
        )
...
async def get_recent_fights(
    ...
    try:
        ...
        logger.error(f"获取最近战斗失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取最近战斗失败: {str(e)}", code=500
        )
...
async def get_parse_status(db: Session = Depends(get_db)):
    ...
    try:
        ...
        return ApiResponse(
            success=False, message=f"获取解析状态失败: {str(e)}", code=500
        )
...
async def get_ai_score_distribution(
    ...
    try:
        ...
        logger.error(f"获取AI评分分布失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取评分分布失败: {str(e)}", code=500
        )
...
async def get_buff_overview(
    ...
    try:
        ...
        logger.error(f"获取Buff概览失败: {e}", exc_info=True)
        return ApiResponse(
            success=False, message=f"获取Buff概览失败: {str(e)}", code=500
        )
